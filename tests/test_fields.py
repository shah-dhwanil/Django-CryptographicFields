...
class Fields(TestCase):
    setattr(settings, 'CRYPTOGRAPHY_KEY',
    ...
    def test_character(self):
        obj=Character.objects.create(char="test",email="abc@abc.com",text="test",slug="test",ip="127.0.0.1",url="https://www.google.com",file="test.png")
        obj.refresh_from_db()
    ...
    def test_uuid(self):
        ...
        obj=Uuid.objects.create(uuid=uuid5(NAMESPACE_URL,"www.google.com").hex)
        obj.refresh_from_db()
        self.assertEqual(obj.uuid,uuid5(NAMESPACE_URL,"www.google.com"))
    ...
    def test_datetime(self):
        ...
        obj=DateTime.objects.create(datetime=datetime,date=datetime.date(),time=datetime.time())
        obj.refresh_from_db()
